...
const FORM_MODULES = [
  ...
  // ── 1. GÉNÉRALITÉS & MESURES ───────────────────────────────
  {
    ...
    fields: [
      ...
      { id: 'section_acces_mesures', label: '— ACCÈS & MESURES SUPPLÉMENTAIRES —', type: 'section' },
      { id: '__mesures_libres', label: 'Mesures supplémentaires', type: 'mesures_libres' },
  ...
  // ── 3. CIRCUITS CHAUFFAGE ──────────────────────────────────
  {
    ...
    fields: [
      ...
      { id: 'chauf_pression_amont', label: 'Pression amont pompe (bar)', type: 'number', step: '0.1' },
      { id: 'chauf_pression_aval', label: 'Pression aval pompe (bar)', type: 'number', step: '0.1' },
  ...
  // ── 4. CIRCUITS ECS ────────────────────────────────────────
  {
    ...
    fields: [
      ...
      { id: '__mesures_ecs', label: 'Points de mesure', type: 'mesures_temp',
        pointOptions: ['Départ ECS','Retour bouclage','Température ballon','Autre'] },
