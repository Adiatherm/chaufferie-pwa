...
const FORM_MODULES = [
  ...
  // ── 1. GÉNÉRALITÉS & MESURES ───────────────────────────────
  {
    ...
    fields: [
      ...
      { id: 'section_mesures_libres', label: '— MESURES LIBRES —', type: 'section' },
      { id: 'mesure_1_label', label: 'Mesure 1 — Libellé', type: 'text', placeholder: 'Ex: Diamètre cheminée' },
      { id: 'mesure_1_val',   label: 'Mesure 1 — Valeur', type: 'text' },
      { id: 'mesure_2_label', label: 'Mesure 2 — Libellé', type: 'text' },
      { id: 'mesure_2_val',   label: 'Mesure 2 — Valeur', type: 'text' },
